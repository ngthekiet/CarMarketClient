...
import ManagerOrder from "~/pages/Dashboard/ManagerOrder";
import OrderDetailInfo from "~/pages/Dashboard/ManagerOrder/OrderDetailInfo";
...
const privateRoutes = [
    {path: config.routes.dashboard, component: ManagerOrder, layout: "dashboard"},
    {path: config.routes.managerOrder, component: ManagerOrder, layout: "dashboard"},
    ...
    {path: config.routes.orderInfo, component: OrderDetailInfo, layout: "dashboard"},
]
